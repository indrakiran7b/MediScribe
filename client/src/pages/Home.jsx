...
const Home = () => {
  ...
  return (
    <div>
      <div className='mt-10'>
        <h1 class="text-3xl font-manrope font-bold bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 animate-typing mx-auto my-4 text-center">
        ...
        <h4 className='font-manrope text-new_color font-semibold  mx-75 text-center'>
          ...
          <div className='flex items-center justify-center mt-6'>
                ...
                <button onClick={() => navigate('/doctors')} class="relative inline-block text-lg group">
                      <span class="relative z-10 block px-5 py-3 overflow-hidden font-medium leading-tight text-gray-800 transition-colors duration-300 ease-out border-2 border-gray-900 rounded-lg group-hover:text-white">
                      <span class="absolute inset-0 w-full h-full px-5 py-3 rounded-lg bg-gray-50"></span>
                      <span class="absolute left-0 right-0 w-50 h-48 -ml-2 transition-all duration-300 origin-top-right -rotate-90 -translate-x-full translate-y-12 bg-gray-900 group-hover:-rotate-180 ease"></span>
